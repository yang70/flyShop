var FlyShop = function(location) {
  ...
  // this.inventoryArray = [this.rods, this.reels, this.line, this.leaders, this.waders, this.dryFlies, this.wetFlies];
};
...
FlyShop.prototype.stockInventory = function(){
  ...
  this.dryFlies = 500;
  this.wetFlies = 500;
  // function createInventory(element, index, array){
  //   element = 100;
  // }
  // this.inventoryArray.forEach(createInventory);
};
