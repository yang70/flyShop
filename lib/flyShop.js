...
FlyShop.prototype.stockInventory = function(productArray){
  function addProduct(element, index, array){
    this[element[0]] = element[1];
  }

  productArray.forEach(addProduct);
  // this.rods = 50;
  // this.reels = 50;
  // this.line = 50;
  // this.leaders = 200;
...
var products = [['rods', 50],['reels', 60]];

shop.stockInventory(products);

console.log(shop.listInventory());

console.log(shop['rods']);
